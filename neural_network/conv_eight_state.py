...
##### (2) Load Data ########################################################################################################
x_train = np.load(open('x_win17_seqpad_train_17k_8.npy', 'rb'), allow_pickle=True) # this is for 17000 proteins
y_train = np.load(open('y_win17_seqpad_train_17k_8.npy', 'rb'), allow_pickle=True)
x_val = np.load(open('conv_108_dim/x_win17_seqpad_val.npy', 'rb'), allow_pickle=True)
y_val = np.load(open('conv_108_dim/y_win17_seqpad_val_8.npy', 'rb'), allow_pickle=True)
